...
class SwiftMailer {
	...
	public function smtpTransport($host='s1-sanjose.accountservergroup.com', $port='465') {
		$mailer = Swift_SmtpTransport::newInstance($host, $port, 'ssl');
		$mailer->setUsername('noreply@circorum.com');
		$mailer->setPassword('Jzn((<[j8M_\ch@d{');
		return $mailer;
	}
