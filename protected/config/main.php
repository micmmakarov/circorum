	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
				''=>'category/view',
				'/'=>'category/view',
				'r/<action:\w+>'=>'Registration/<action>',
				'c/<cname:[A-Za-z0-9_ ]+>/<id:\d+>/<sname:[A-Za-z0-9_ ]+>'=>'submission/view',
				'c/<name:[A-Za-z0-9_ ]+>'=>'category/view',
				'c/'=>'category/view',
		...
		'mywidget' => array(
			'class' => 'application.widgets.MyWidget',
		),
	),
