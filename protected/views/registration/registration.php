...
<?php echo Yum::requiredFieldNote(array('class' => 'alert-box warning')); ?>
<?php echo CHtml::errorSummary(array($form, $profile),array('class' => 'alert-box error')); ?>
...
<?php if(extension_loaded('gd') 
	...
	<div class="row submit" style="padding-top:20px;">
		<?php echo CHtml::submitButton(Yum::t('Registration'), array('class' => 'large blue nice button radius')); ?>
	</div>
